...
using System.Windows.Forms;
 ...
 {  
      ...
      /// <summary>
      /// Class to handle clipboard objects that represent files.
      /// </summary>
        public class FileDataObject: System.Windows.Forms.IDataObject
        {
            ...
            public FileDataObject(System.Windows.Forms.IDataObject underlyingDataObject)
            {
                ...
                switch(format)
                {
                    ...
                    case "FileGroupDescriptorW":
                        ...
                        try
                        {
                            ...
                            if (fileGroupDescriptorStream == null) return new string[]
                                {
                                    ""
                                };
                            byte[] fileGroupDescriptorBytes = new byte[fileGroupDescriptorStream.Length];
